...
class Visualize:
    ...
    def create_baseline_plots(self):
        self.create_plots(self.data.data["y"], self.data.data["y_hat_old"], suffix="-old")
    ...
    def z_plot(self, y, y_hat, suffix=""):
        ...
        self.module.logger.experiment.add_image(f"z-plot{suffix}", img, self.module.current_epoch)
    ...
    def hist_plot(self, y, y_hat, suffix=""):
        ...
        img = self.fig2buf2tensor(fig)
        self.module.logger.experiment.add_image(f"z-hist{suffix}", img, self.module.current_epoch)
